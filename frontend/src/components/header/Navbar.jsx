                ...
                <div className="hidden md:flex space-x-6 items-center text-white font-medium">
                    ...
                    {isLoggedIn ? (
                        <button
                            ...
                            className="text-white border border-white px-4 py-1 rounded-full hover:bg-white hover:text-slate-900 transition"
                        >
                            Logout
                        </button>
                    ) : (
            ...
            {isOpen && (
                <div className="md:hidden flex flex-col space-y-3 mt-4 text-white font-medium">
                    ...
                    {isLoggedIn ? (
                        <button
                            onClick={handleLogout}
                            className="text-white px-4 py-2 rounded-full border border-white hover:bg-white hover:text-slate-900 transition"
                        >
                            Logout
                        </button>
                    ) : (
